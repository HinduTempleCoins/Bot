...
async function signupHandler() {
  ...
  return [
    ...
    '',
    'Pick how you want to sign up here — there is more than one way, and others can offer their own:',
    'https://alpha.melek.salon/account/get-started.html',
    '',
    ...
    '',
    'New and unsure? Chat with me and say "I have no idea what I\'m doing" and I will walk you through it.',
