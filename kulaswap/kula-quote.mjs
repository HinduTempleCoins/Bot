// VENDORED (browser-safe) from Bot integrations/cp-amm.mjs — KulaSwap constant-product quote math.
// CLI guard typeof-guarded so it imports cleanly in a browser (the pool-brain lesson).
...
if (typeof process !== "undefined" && process.argv[1] && process.argv[1].endsWith('cp-amm.mjs')) {
