...
- **Backlog (operator ideas, 2026-06-14, not yet built):** (1) embed the **Hathor ChatBox on the pool page** (pool.soapbox.community) so miners can talk to her — she's already the OnboardingChat widget on signup; (2) *possible* **vaporwave restyle of Hathor's ChatBox** (flagged as a maybe, no commitment).
