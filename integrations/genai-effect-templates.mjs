...
export const EFFECT_TEMPLATES = [
  ...
  { id: 'with-tupac', title: 'With Tupac', category: 'figures',
    ...
    negative: 'blurry, deformed' },
  // ── from the Van Kush / Apsara Apparel shirt line — appear AS these subjects ──────────────────────
  { id: 'as-sadhu', title: 'As a Sadhu', category: 'figures',
    prompt: '{{subject}} as a Himalayan sadhu holy man, ash-marked skin, rudraksha beads, matted hair, serene by the Ganges, devotional art',
    negative: 'disrespectful, blurry' },
  { id: 'as-yogi', title: 'As a Meditating Yogi', category: 'figures',
    prompt: '{{subject}} as a serene yogi in deep meditation, lotus posture, tilak, Om Namah Shivaya, glowing aura, temple at dawn',
    negative: 'disrespectful, blurry' },
  { id: 'with-vivekananda', title: 'With Swami Vivekananda', category: 'figures',
    prompt: '{{subject}} standing beside Swami Vivekananda in a dignified 1890s portrait, saffron robe and turban, sepia',
    negative: 'blurry, disrespectful' },
  { id: 'as-apsara', title: 'As an Apsara Dancer', category: 'figures',
    prompt: '{{subject}} as a celestial Apsara dancer, ornate golden Khmer-Indian temple regalia, graceful mudras, devotional art',
    negative: 'blurry, deformed' },
  { id: 'as-asclepius', title: 'As Asclepius (Healer)', category: 'figures',
    prompt: '{{subject}} as Asclepius holding the rod of healing entwined with a serpent, classical robes, temple of medicine',
    negative: 'blurry, deformed' },
  { id: 'as-hygieia', title: 'As Hygieia (Health)', category: 'figures',
    prompt: '{{subject}} as the goddess Hygieia with a bowl and serpent, flowing classical robes, serene, temple of healing',
    negative: 'blurry, deformed' },
  { id: 'as-rasta-lion', title: 'As the Lion of Judah (Irie)', category: 'figures',
    prompt: '{{subject}} as a majestic Rasta Lion of Judah with a flowing mane, red-gold-green regalia, reggae-spiritual, warm light',
    negative: 'blurry, deformed' },
  { id: 'as-kemetic-cat', title: 'As a Kemetic Cat Guardian', category: 'figures',
    prompt: '{{subject}} as a regal Kemetic cat-guardian in the style of ancient Egyptian temple art, gold collar, hieroglyphs',
    negative: 'blurry, deformed' },
  { id: 'with-el-chapo', title: 'With El Chapo', category: 'figures',
    prompt: '{{subject}} standing beside Joaquin El Chapo Guzman in a stylized telenovela crime-drama scene, sharp suits, dramatic lighting, cinematic',
    negative: 'weapons toward viewer, drugs, gore, blurry' },
  // ── mobsters (deceased — artistic/dramatized crime-cinema) ────────────────────────────────────────
  { id: 'with-capone', title: 'With Al Capone', category: 'figures',
    prompt: '{{subject}} beside Al Capone in a 1920s Chicago speakeasy, pinstripe suits and fedoras, vintage film grain',
    negative: 'weapons toward viewer, gore, blurry' },
  { id: 'with-escobar', title: 'With Pablo Escobar', category: 'figures',
    prompt: '{{subject}} beside Pablo Escobar in a stylized 1980s crime-drama scene, tropical villa, cinematic',
    negative: 'weapons toward viewer, drugs, gore, blurry' },
  { id: 'with-gotti', title: 'With John Gotti', category: 'figures',
    prompt: '{{subject}} beside John Gotti outside a New York social club, sharp 1980s suits, press cameras',
    negative: 'weapons toward viewer, gore, blurry' },
  { id: 'with-luciano', title: 'With Lucky Luciano', category: 'figures',
    prompt: '{{subject}} beside Lucky Luciano in a 1930s New York scene, three-piece suits, sepia, cinematic',
    negative: 'weapons toward viewer, gore, blurry' },
  { id: 'with-frank-lucas', title: 'With Frank Lucas', category: 'figures',
    prompt: '{{subject}} beside Frank Lucas in a 1970s Harlem scene, fur coat, vintage cars, film grain',
    negative: 'weapons toward viewer, drugs, gore, blurry' },
  { id: 'with-lansky', title: 'With Meyer Lansky', category: 'figures',
    prompt: '{{subject}} beside Meyer Lansky in a mid-century casino, tailored suits, cigar smoke, cinematic',
    negative: 'gore, blurry' },
  { id: 'as-crime-boss', title: 'As a Crime Boss', category: 'figures',
    prompt: '{{subject}} as a powerful old-school crime boss at the head of a dim boardroom table, tailored suit, dramatic single light',
    negative: 'weapons toward viewer, gore, blurry' },
  // ── spiritual leaders (deceased unless noted; respectful) ─────────────────────────────────────────
  { id: 'with-gandhi', title: 'With Gandhi', category: 'figures',
    prompt: '{{subject}} sitting respectfully beside Mahatma Gandhi, simple khadi cloth, spinning wheel, dignified 1940s photo',
    negative: 'disrespectful, blurry' },
  { id: 'with-dalai-lama', title: 'With the Dalai Lama', category: 'figures',
    prompt: '{{subject}} beside the Dalai Lama, warm smiles, saffron and maroon robes, monastery light, respectful',
    negative: 'disrespectful, blurry' },
  { id: 'with-yogananda', title: 'With Paramahansa Yogananda', category: 'figures',
    prompt: '{{subject}} beside Paramahansa Yogananda, long dark hair, ochre robe, serene devotional 1930s portrait',
    negative: 'disrespectful, blurry' },
  { id: 'with-ramakrishna', title: 'With Sri Ramakrishna', category: 'figures',
    prompt: '{{subject}} beside Sri Ramakrishna in a Kolkata temple, devotional bliss, sepia, respectful',
    negative: 'disrespectful, blurry' },
  { id: 'with-ramana', title: 'With Ramana Maharshi', category: 'figures',
    prompt: '{{subject}} beside Ramana Maharshi at the foot of Arunachala, serene silence, devotional photo',
    negative: 'disrespectful, blurry' },
  { id: 'with-neem-karoli', title: 'With Neem Karoli Baba', category: 'figures',
    prompt: '{{subject}} beside Neem Karoli Baba wrapped in a plaid blanket, warm devotional ashram scene',
    negative: 'disrespectful, blurry' },
  { id: 'with-mother-teresa', title: 'With Mother Teresa', category: 'figures',
    prompt: '{{subject}} beside Mother Teresa in a blue-bordered white sari, compassionate, dignified photo',
    negative: 'disrespectful, blurry' },
  { id: 'with-rumi', title: 'With Rumi', category: 'figures',
    prompt: '{{subject}} beside the poet Rumi, whirling dervish robes, Persian courtyard, candlelight, mystical',
    negative: 'disrespectful, blurry' },
  { id: 'with-lao-tzu', title: 'With Lao Tzu', category: 'figures',
    prompt: '{{subject}} beside Lao Tzu riding a water buffalo through misty mountains, ancient Taoist ink-painting style',
    negative: 'disrespectful, blurry' },
  { id: 'with-thich-nhat-hanh', title: 'With Thich Nhat Hanh', category: 'figures',
    prompt: '{{subject}} walking mindfully beside Thich Nhat Hanh, brown monastic robes, peaceful garden, respectful',
    negative: 'disrespectful, blurry' },
  { id: 'as-enlightened-guru', title: 'As an Enlightened Guru', category: 'figures',
    prompt: '{{subject}} as a radiant enlightened guru seated in lotus, glowing halo, garland, devotees, temple, devotional art',
    negative: 'disrespectful, blurry' },
