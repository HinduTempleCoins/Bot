...
export const PUBLIC_SITES = [
  ...
  { slug: 'lexicon', url: 'https://lexicon.soapbox.community', name: 'MELEK Legal Lexicon' },
  { slug: 'world-law', url: 'https://world-law.soapbox.community', name: 'SoapBox World Law' },
  { slug: 'philosophy', url: 'https://philosophy.soapbox.community', name: 'SoapBox Philosophy' },
  { slug: 'free-speech', url: 'https://free-speech.soapbox.community', name: 'SoapBox Free Speech & Sedition' },
