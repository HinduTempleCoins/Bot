...
export const SURFACES = Object.freeze([
  // ── money ──────────────────────────────────────────────────────────────────────────────────────
  { slug: 'benefits', host: 'benefits.soapbox.community', cat: 'money', state: B, name: 'Benefits Navigator',
  ...
  { slug: 'credit', host: 'credit.soapbox.community', cat: 'money', state: B, name: 'Credit Help',
    blurb: 'How scores work and how to defend one, pointing only at the free official tools and nonprofit help. Nothing for sale.' },
  { slug: 'business', host: 'business.soapbox.community', cat: 'money', state: B, name: 'Business Credit',
  ...
  { slug: 'insurance', host: 'insurance.soapbox.community', cat: 'money', state: B, name: 'Insurance' },
  { slug: 'jobs', host: 'jobs.soapbox.community', cat: 'money', state: B, name: 'Jobs' },
  ...
  { slug: 'stream', host: 'stream.soapbox.community', cat: 'media', state: B, name: 'SoapBox Stream',
    ...
    note: 'Built and tested. The host does not resolve — DNS and vhost were never created for it.' },
  ...
  { slug: 'cams', host: 'cams.soapbox.community', cat: 'media', state: B, name: 'Live Cams',
    note: 'Built. Host not created.' },
  { slug: 'gallery', host: 'gallery.melek.salon', cat: 'media', state: B, name: 'Gallery', note: 'Built. Host not created.' },
  ...
  { slug: 'comms', host: 'comms.soapbox.community', cat: 'infra', state: B, name: 'Comms',
  ...
  // ── tools ──────────────────────────────────────────────────────────────────────────────────────
  { slug: 'tools', host: 'tools.soapbox.community', cat: 'tools', state: B, name: 'Tools hub' },
  ...
  // ── games ──────────────────────────────────────────────────────────────────────────────────────
  { slug: 'games', host: 'games.soapbox.community', cat: 'games', state: B, name: 'Games' },
