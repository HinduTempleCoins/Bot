...
const URGENT = ['urgent', 'asap', 'now', 'immediately', 'today', 'deadline', 'broken', 'broke', 'crash', 'crashed', 'down', 'fail', 'failed', 'failing', 'fails', 'blocked', 'stuck', 'hang', 'stall', 'stalled', 'regression', 'outage', 'expired', 'expiring', 'explode', 'exploding', 'lava', 'drowning', 'falling', 'burning'];
