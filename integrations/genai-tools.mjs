...
export const TOOLS = [
  ...
  { id: 'symbols', title: 'Sacred Symbols', cat: 'Create', url: '/symbols', what: 'Over two hundred real religious and occult symbols across traditions and time (Egyptian, Mesopotamian, Punic, Greek, Hebrew, Christian, Hindu, Buddhist, Taoist, Norse, Celtic, alchemy, astrology…) as clean images, each with its history, whether that history is attested, disputed or modern, its sources and its image credit.',
    howto: ['Open Sacred Symbols.', 'Search or browse by tradition.', 'Open a symbol to read where it comes from and what it means.', 'Download the PNG, or add it to the Reference Studio as an object.', 'Keep the image credit shown on the page.'] },
