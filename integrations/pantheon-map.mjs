...
export const EQUATIONS = [
  ...
  { a: 'tanit', b: 'neith', tier: 'conjecture', systems: ['linguistics'],
    source: 'The Egyptian ta-Nit = "she of Neith" proposal. NO scholarly source could be found for it.',
    note: 'DOWNGRADED BACK TO CONJECTURE, and the reversal is recorded rather than hidden. It was briefly raised to structural on the strength of the ta-Nit derivation. A lexical pass then found (a) that no citable scholar states it, (b) that the Punic form is TNT/TNNT and the Greek transliterations at El-Hofra give TINNĪT, not Tanit, and (c) that the t-…-t frame is BOTH a Berber feminine circumfix and a Semitic feminine ending, so the shape supports either origin and proves neither. A derivation with no author behind it is a conjecture no matter how often it is repeated.' },
  { a: 'tanit', b: 'athena', tier: 'structural', systems: ['greek-myth', 'archaeology'],
    source: 'Herodotus IV.180: Libyan (Berber) maidens at Lake Tritonis in ritual combat for a goddess the Greeks call Athena \u2014 in the region that is Tinnīt\u2019s own heartland.',
    note: 'THE LEG THAT HOLDS, and it does NOT run through Neith. Herodotus puts an Athena-cult among Berbers next to Carthage, which is a real geographic and cultic overlap with Tinnīt. That is independent of the ta-Nit etymology and survives its collapse. Still structural, not attested: Herodotus names Athena and the Libyans, never Tinnīt. And note that the Romans meeting her reached for CAELESTIS, not Minerva.' },
...
export const ETYMOLOGY = {
  ...
  neith: { form: 'nt', gloss: 'essentially unknown. Pinch hypothesises "the terrifying one"; the links to the red crown and the weaving shuttle are iconographic, not etymological. Do not put a confident gloss on Neith.', confidence: 'unknown' },
  ...
  tanit: { form: 'TNT / TNNT — vocalised TINNĪT', gloss: 'The vocalisation is settled and it is not "Tanit": Punic inscriptions transliterated into Greek at El-Hofra near Constantine (published 1955) give Θινιθ and Θεννειθ, i.e. Tinnīt. "Tanit" is an arbitrary modern vocalisation of an unpointed TNT. The DERIVATION is open — the t-…-t frame is a Berber feminine circumfix AND a Semitic feminine ending, so the shape argues for both and settles neither.', confidence: 'disputed' },
  ...
  atlas: { form: 'Ἄτλας', gloss: 'traditionally a- + *telh₂- "to bear". The Berber route needs splitting in two: Proto-Berber *a-dərar "mountain" ~ Ancient Libyan Δύρεν, the native name of the Atlas range in classical authors, is WELL SUPPORTED. The further step from adrar to Greek Atlas is asserted without a named scholar and should be held separately.', confidence: 'disputed' },
  ...
  'soma-deva': { form: 'PIIr. *sáwHma- < √sawH-', gloss: 'the pressed one — exact cognate of Avestan haoma. Attestation is Indo-Iranian only. NOTE: the word being inherited says nothing about the PLANT, which Lubotsky\u2019s BMAC substrate list may place in Central Asia. Two separate claims; do not merge them.', confidence: 'secure' },
  rudra: { form: 'traditionally √rud- "to cry, howl"', gloss: 'UNRESOLVED. "The Howler" is the common view; a lost root "red, ruddy" and Kramrisch\u2019s raudra "wild, untamed" compete, and Sāyaṇa alone offers six derivations. Mallory & Adams reconstruct a PIE *Rudlos from Old Russian Rŭglŭ while conceding the etymology "remains problematic".', confidence: 'unknown' },
  loka: { form: 'PIE *lowk-ó-s < *lewk-', gloss: 'open space, from "to shine" — cognate with Latin lūcus "sacred grove" and English "lea". The ORIGINAL sense is a spatial clearing (RV 6.47.8); "world / plane of existence" is a development.', confidence: 'secure' },
  chakra: { form: 'PIE *kʷekʷlo-', gloss: 'wheel — reduplicated *kʷel- "to turn"; cognate with Greek kyklos and English "wheel". One of the cleanest IE etymologies there is. The WORD is ~4,000 years old; the subtle-body system is ~1,200. See CORRECTIONS.', confidence: 'secure' },
  asura: { form: 'PIIr. *Hásura-', gloss: 'lord. The native a-sura "not-god" derivation is a later back-formation. Note the mirror: asura degrades in Indic while Avestan ahura is exalted — and deva is exalted in Indic while Avestan daēuua means "demon". The same two words, inverted, across one religious schism.', confidence: 'secure' },
  yidam: { form: 'Tibetan yid kyi dam tshig', gloss: 'samaya (bond) of mind. The Tibetan is secure; the usual Sanskrit equation with iṣṭadevatā is NOT. See CORRECTIONS.', confidence: 'secure' },
  ...
  pashupati: { form: 'paśu-pati', gloss: 'lord of animals — a transparent Sanskrit compound. The COMPOUND is secure; the identification with Indus seal M-420 is not. See CORRECTIONS.', confidence: 'secure' },
  ...
  ifri: { form: 'Berber ifri, pl. ifran', gloss: 'cave, hole, burrow — Tashelhit relates it synchronically to the root ffr "to be hidden". Inherited from Proto-Berber. One of TWO live candidates for the name "Africa"; the other is Punic ʿpr "dust". Neither is established.', confidence: 'secure' },
  'africa-dea': { form: 'Latin Africa < Afri (sg. Āfer)', gloss: 'The MIDDLE link is certain: Latin Afri, a people near Carthage, gives Africa terra, the province, and Arabic Ifrīqiya. The origin of Afri is not: Berber ifri "cave" and Punic ʿpr "dust" are both live and neither is established. See CORRECTIONS for the four folk etymologies to refuse.', confidence: 'disputed' },
  gurzil: { form: 'Gurzil', gloss: 'unresolved. A link to Ghirza in Roman Libya is proposed — the site yielded an inscription recording the sacrifice of 51 cattle and a relief of a bull sacrifice, and al-Bakrī records a hilltop sanctuary with a stone idol at a "Gherza" in Tripolitania. That is a plausible identification of place with god, not a demonstrated etymology.', confidence: 'unknown' },
...
CORRECTIONS.push(
  {
    id: 'yidam-ishtadevata',
    claim: 'Tibetan yidam is the Sanskrit iṣṭadevatā, "chosen deity" — so deity yoga can be described through the Sanskrit term.',
    madeIn: 'a hazard for the Botanica theurgy design and any Hathor-as-teacher material, flagged before it is written',
    verdict: 'WRONG — the equation is a modern back-translation',
    because: [
      'Yidam is a contraction of Tibetan yid kyi dam tshig, "the samaya (bond) of mind". That derivation is secure.',
      'The Sanskrit iṣṭadevatā gloss "has not been attested in any Buddhist tantric text in Sanskrit". It appears to be a modern rendering back INTO Sanskrit, not a traditional equivalence.',
      'This matters practically: iṣṭadevatā carries a Hindu bhakti sense of a personally preferred deity, which is close to the opposite of the Tibetan meaning — a yidam is assigned in initiation and held under vow.',
    ],
    keep: 'Use the Tibetan term and the Tibetan derivation. Deity yoga remains exactly what Botanica wants — a documented ritual technology for generating a deity in a form — but describe it as yid kyi dam tshig, a bond, not as a chosen favourite.',
    source: 'The Tibetan etymology is standard; the absence of iṣṭadevatā from the Sanskrit tantric corpus is the reported finding.',
  },
  {
    id: 'pashupati-seal',
    claim: 'The Paśupati seal shows proto-Śiva — Lord of Animals from the Indus Valley, who became Greek Pan and Hindu Shiva.',
    madeIn: 'the "Religion is not a Game" thread; the Pashupata Shaivism material',
    verdict: 'WRONG as stated — specialists reject the identification',
    because: [
      'Marshall\u2019s 1928-31 reading of Mohenjo-daro seal M-420 rested on three faces, a horned headdress read as a triśūla, a yogic posture, and surrounding animals.',
      'Doris Srinivasan: the lateral projections are cow-like EARS, not faces; the figure is a divine buffalo-man.',
      'Herbert Sullivan: the figure is female, and the "erect phallus" is a dangling waistband of the type found on female terracottas.',
      'Alf Hiltebeitel: the horns are unambiguously BUFFALO, not bull — which points to Mahiṣāsura, the buffalo DEMON, rather than to Shiva.',
      'Doniger: resemblance to later Hindu imagery cannot by itself establish continuity across two millennia of unattested transmission.',
    ],
    keep: 'paśu + pati = "lord of animals" is a transparent and secure Sanskrit compound, and the Master-of-Animals ICONOGRAPHIC TYPE is genuinely widespread. Both survive. What does not survive is the leap from a 3rd-millennium seal to a Sanskrit epithet attested millennia later, and the Pan equation rests on that leap.',
    source: 'Srinivasan; Sullivan; Hiltebeitel; Doniger. Farmer, Sproat & Witzel 2004 call it "Marshall\u2019s notorious proto-Śiva seal".',
  },
  {
    id: 'indus-script-linguistic',
    claim: 'The Indus script encodes Dravidian, and the fish-signs are read by the *mīn "fish / star" rebus.',
    madeIn: 'the Indus and Dravidian threads generally',
    verdict: 'OPEN, and weaker than usually presented',
    because: [
      'Nobody has deciphered it, and over a hundred claimed decipherments have reached print since 1877.',
      'Farmer, Sproat & Witzel 2004: the average inscription is 4.6 signs; the longest on one surface is 17. Only 21 Linear Elamite inscriptions are known and MOST OF THEM ARE LONGER than the longest Indus text.',
      '27% of the 417 signs in Mahadevan\u2019s concordance occur exactly once, and singleton counts keep RISING with each new excavation — the opposite of what happens as a real script\u2019s corpus grows.',
      'Rao et al. 2009 argued from conditional entropy that the corpus is linguistic. Sproat showed the comparison classes were artificially generated, and that the result is reproducible from 400 elements with a Zipf distribution and conditional independence — i.e. from a corpus with no syntax at all.',
      'Sproat 2014 (Language 90.2) validated the measures against real control corpora and classified the Indus corpus as NONLINGUISTIC.',
    ],
    keep: 'Parpola\u2019s classification of the seals is used universally and independently of his decipherment — cite that, not the reading. State the position as contested, name Parpola and Mahadevan on one side and FSW/Sproat on the other, and do not write "the Indus script encodes Dravidian" as fact.',
    source: 'Farmer, Sproat & Witzel, "The Collapse of the Indus-Script Thesis", EJVS 11-2 (2004); Sproat, Computational Linguistics 36(3) 2010; Sproat, Language 90(2) 2014',
  },
  {
    id: 'africa-etymologies',
    claim: 'The name Africa derives from [pick one]: Egyptian af-rui-ka "birthplace"; Greek a-phrike "without cold"; Latin aprica "sunny"; Hebrew Ophir; Epher, grandson of Abraham.',
    madeIn: 'a hazard — all five circulate widely, and the Egyptian one especially in Afrocentric material',
    verdict: 'ALL FIVE REJECTED — and two candidates remain, neither established',
    because: [
      'af-rui-ka "birthplace": there is no such phrase in any Egyptian lexicon. This one will draw pushback, so cite Erman-Grapow or the TLA when refusing it.',
      'a-phrike "without cold" and aprica "sunny": listed as folk etymologies; the aprica guess is Isidore of Seville\u2019s.',
      'Ophir and Epher: ancient eponymous fabrication, the Epher version from Josephus.',
      'africus "south wind": the wind is named FROM the place, not the reverse.',
      'What IS certain is the middle link: Latin Afri (sg. Āfer), a people near Carthage, gives Africa terra, then the province, then Arabic Ifrīqiya.',
    ],
    keep: 'Two live candidates for the origin of Afri: Berber ifri "cave" (plural ifran — with the Moroccan town Ifrane, the Banu Ifran tribe from Yafran in Libya, and the Roman-era North African goddess Ifru/Africa all supporting it) and Punic ʿpr "dust" from Proto-Semitic *ʕapar-. The ifri route is the better of the two — Berber for a Berber ethnonym, with toponymic support and a divine name sitting right there — but better is not established, and the lexica say both lack consensus.',
    source: 'Wiktionary s.v. Africa and the Name of Africa survey; the ifri proposal is dated to 1981 and its author could not be identified',
  },
  {
    id: 'ptah-the-opener',
    claim: 'Ptah means "the opener".',
    madeIn: 'this repo\u2019s own etymology table, before correction',
    verdict: 'WRONG',
    because: [
      'The attested Egyptian verb ptḥ means "to make, to form, to create" — which is exactly why he is patron of craftsmen and the Memphite creator.',
      'The "opener" gloss assimilates it to the Semitic homograph ptḥ "to open". Same three consonants, different language, different meaning.',
    ],
    keep: 'Gloss it "to make, to form". Note also that whether the theonym derives from the verb or the verb is a back-formation from the craftsman-god is genuinely open.',
    source: 'Wiktionary s.v. ptḥ (Egyptian); the Greek reflex is Φθά, Coptic ⲡⲧⲁϩ, Phoenician 𐤐𐤕𐤇',
  },
  {
    id: 'elamo-dravidian',
    claim: 'Elamite and Dravidian are related, linking the Indus world westward to Iran.',
    madeIn: 'a hazard flagged before use',
    verdict: 'NOT ACCEPTED — usable as a named proposal, never as a premise',
    because: [
      'McAlpin (1974-75) claimed 20% cognate vocabulary plus shared pronouns, case endings and tense markers.',
      'Krishnamurti and Zvelebil: the morphological correspondences are ad hoc and lack phonological motivation.',
      'Georgiy Starostin, which is the killing objection: the correspondences are "no closer than correspondences with other nearby language families". If the signal is not stronger than chance against unrelated neighbours, there is no signal.',
      'Elamite is mainstream-classified as a language isolate.',
    ],
    keep: 'Cite it as a proposal with a named author and a named reception. It cannot carry weight in an argument.',
    source: 'McAlpin 1974/1975; Krishnamurti; Zvelebil; G. Starostin',
  },
);
