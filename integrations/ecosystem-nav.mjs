...
export const ECOSYSTEM_LINKS = [
  ...
  { label: 'Legal Lexicon', url: env('LEXICON_SITE', 'https://lexicon.soapbox.community'), group: 'SoapBox', live: true, key: 'lexicon' },
  { label: 'Case Law of Us', url: env('CASELAW_SITE', 'https://caselaw.soapbox.community'), group: 'SoapBox', live: true, key: 'caselaw' },
  { label: 'World Law', url: env('WORLDLAW_SITE', 'https://world-law.soapbox.community'), group: 'SoapBox', live: false, key: 'world-law' },
  { label: 'Free Speech', url: env('FREESPEECH_SITE', 'https://free-speech.soapbox.community'), group: 'SoapBox', live: true, key: 'free-speech' },
  { label: 'Faux Law Files', url: env('ENCOUNTERS_SITE', 'https://encounters.soapbox.community'), group: 'SoapBox', live: true, key: 'encounters' },
