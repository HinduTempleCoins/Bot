...
export const ECOSYSTEM_LINKS = [
  ...
  { label: 'Benefits', url: env('BENEFITS_SITE', 'https://benefits.soapbox.community'), group: 'SoapBox', live: true, key: 'benefits' },
  { label: 'Plate', url: env('PLATE_SITE', 'https://plate.soapbox.community'), group: 'SoapBox', live: true, key: 'plate' },
  { label: 'Comms', url: env('COMMS_SITE', 'https://comms.soapbox.community'), group: 'SoapBox', live: true, key: 'comms' },
  { label: 'Business Credit', url: env('BUSINESS_SITE', 'https://business.soapbox.community'), group: 'SoapBox', live: true, key: 'business' },
