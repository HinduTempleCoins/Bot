...
const NAV = [
  ...
  ['/exchanges', 'Exchanges'], ['/macro', 'Macro'], ['/commodities', 'Commodities'], ['/forex', 'Forex'], ['/scams', 'Scam Tracker'], ['https://abuck.soapbox.community', 'Stores'], ['/directory', 'Directory'], ['/ecosystem', 'Ecosystem'], ['/learn', 'Learn'],
];
