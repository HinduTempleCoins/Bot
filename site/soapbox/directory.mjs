...
export const DIRECTORY = [
  ...
  { cat: 'Internet Archives & Old Web', items: [
    { name: 'Internet Archive', url: 'https://archive.org', blurb: 'The big one — free library of texts, software, music, video + the Wayback Machine.' },
    { name: 'Wayback Machine', url: 'https://web.archive.org', blurb: 'Browse snapshots of any URL across the years; the canonical web time machine.' },
    { name: 'Archive Team', url: 'https://wiki.archiveteam.org', blurb: 'Volunteer archivists who race to rescue sites before they go dark (GeoCities, etc.).' },
    { name: 'Oldweb.today', url: 'https://oldweb.today', blurb: 'Browse archived pages inside emulated period browsers (Netscape, old IE) in your browser.' },
    { name: 'The Old Net', url: 'https://theoldnet.com', blurb: 'A 90s-style proxy that re-serves Wayback pages stripped for vintage browsers.' },
    { name: 'OoCities', url: 'https://www.oocities.org', blurb: 'The most complete mirror of GeoCities, indexed by old usernames + neighborhoods.' },
    { name: "Cameron's World", url: 'https://www.cameronsworld.net', blurb: 'A web-collage built from text + images excavated from archived GeoCities pages.' },
    { name: 'Floodgap Gopher', url: 'https://gopher.floodgap.com', blurb: 'Gateway into Gopherspace — the pre-web protocol still quietly alive.' },
    { name: 'textfiles.com', url: 'http://textfiles.com', blurb: "Jason Scott's living museum of BBS-era text files from the 80s and 90s." },
    { name: 'Neocities', url: 'https://neocities.org', blurb: 'Free static web hosting reviving the make-your-own-homepage spirit of GeoCities.' },
    { name: 'Project Gutenberg', url: 'https://www.gutenberg.org', blurb: '75,000+ free public-domain ebooks — the oldest digital library (since 1971).' },
    { name: 'Curlie', url: 'https://curlie.org', blurb: 'The community-run successor to the DMOZ Open Directory of human-curated links.' },
    { name: 'Bitsavers', url: 'https://bitsavers.org', blurb: 'Vast archive of scanned vintage-computing manuals, docs, and software.' },
    { name: 'Computer History Museum', url: 'https://computerhistory.org', blurb: 'Exhibits + online collections preserving the history of computing.' },
    { name: 'UK Web Archive', url: 'https://www.webarchive.org.uk', blurb: 'The British Library-led archive of UK websites since 2004.' },
  ] },
];
