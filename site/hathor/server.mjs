  ...
  const body = `<h1>AI Art Filters <span class=muted style="font-size:14px">· Hathor runs your tools for you</span></h1>
    ...
    <form class=gform id=fltf><div class=card>
      ...
      <div class=row style="margin-top:12px;gap:10px;flex-wrap:wrap;align-items:center">
        <label class=fld style="width:auto">Filter <select class=q id=fltop style="width:auto">${opts}</select></label>
        <button type=submit id=fltbtn>Apply &amp; download</button><span class=muted id=fltstatus style="font-size:12px"></span></div>
    </div></form>
