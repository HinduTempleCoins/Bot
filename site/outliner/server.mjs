...
<header class=topbar><a class=brand href="/">🌳 SoapBox <span>Outliner</span><span class=alpha>Alpha</span></a>
  <div class=topbar-r><a href="/">New</a><button type=button id=nav-save>☁ Sync &amp; publish</button></div></header>
...
export async function handler(req, res) {
  try {
    ...
    return res.end(page('Not found — SoapBox Outliner', '<h1>Not found</h1><p class=muted>That page doesn\'t exist. <a href="/">Open the outliner</a>.</p>', { robots: 'noindex,follow' }));
  } catch (e) {
