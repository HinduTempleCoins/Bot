...
export async function handler(req, res) {
  try {
    ...
    return res.end(page('Not found — SoapBox Habits', '<h1>Not found</h1><p class=muted>That page doesn\'t exist. <a href="' + bp('/') + '">Open the habit tracker</a>.</p>', { robots: 'noindex,follow' }));
  } catch (e) {
