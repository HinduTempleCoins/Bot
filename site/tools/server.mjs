...
export const UTILITIES = [
  ...
  { slug: 'soapcalc', emoji: '🧼', name: 'Soap Calculator', tagline: 'Lye, oils & bar quality', blurb: 'A real soap-making lye calculator: enter your oils, get the exact lye, water and the fatty-acid quality of the bar.' },
  { slug: 'percent', emoji: '％', name: 'Percentage Calculator', tagline: '% of, % change & tips', blurb: 'Every everyday percentage question in one place — what is X% of Y, percentage change, and a tip splitter.' },
  { slug: 'dilution', emoji: '🧪', name: 'Dilution Calculator', tagline: 'Mixes, ratios & EO %', blurb: 'Dilute to a target strength, a 1:N ratio, or an essential-oil percentage — for soap, skincare and cleaning.' },
  { slug: 'unitprice', emoji: '🏷️', name: 'Unit Price Calculator', tagline: 'Which pack is cheaper?', blurb: 'Compare price per unit across products and see the best value — the everyday grocery-aisle question, solved.' },
