...
<header class=topbar><a class=brand href="/">🔦 SoapBox <span>Flashlight</span><span class=alpha>Alpha</span></a>
  <div class=topbar-r><a href="/">New</a><button type=button id=nav-save>☁ Save settings</button></div></header>
...
export async function handler(req, res) {
  try {
    ...
    return res.end(page('Not found — SoapBox Flashlight', '<h1>Not found</h1><p class=muted>That page doesn\'t exist. <a href="/">Open the flashlight</a>.</p>', { robots: 'noindex,follow' }));
  } catch (e) {
