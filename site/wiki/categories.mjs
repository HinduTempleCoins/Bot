...
export const CATEGORIES = [
  ...
  },
  {
    ...
    keywords: [/\blaw\b/i, /\brights\b/i, /constitution/i, /treat(y|ies)/i, /maxim/i, /privacy/i, /doctrine/i,
               /benefit societ/i, /mutual aid/i, /fraternal/i, /\bappeals?\b/i, /\bwrits?\b/i,
               /lexicon/i, /world[ -]?law/i, /spirit of the laws/i, /montesquieu/i, /case ?law/i,
