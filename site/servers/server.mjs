...
const EXAMPLE_SERVERS = [
  ...
  { id: 'luanti', name: 'Van Kush Luanti', game: 'Luanti (Minetest)', edition: 'java',
    host: 'luanti.example.com:30000', version: '5.x', desc: 'Our sovereign open-source voxel world — we own the rules here.',
    cam: '', tags: ['open-source', 'sovereign'] },
];
...
function card(s) {
  ...
  <div class=row>
    ${s.cam ? `<a class=btn href="${esc(s.cam)}" target=_blank rel=noopener>📹 Watch the live cam</a>` : ''}
